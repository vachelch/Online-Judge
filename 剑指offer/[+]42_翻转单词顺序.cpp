/*
1. Input string may contain leading or trailing spaces. However, your reversed string should not contain leading or trailing spaces.
2. You need to reduce multiple spaces between two words to a single space in the reversed string.

Also see in Leetcode 151. Reverse Words in a String
*/

// step 1: reverse the whole sentence
// step 2: erase repeated spaces
class Solution {
public:
